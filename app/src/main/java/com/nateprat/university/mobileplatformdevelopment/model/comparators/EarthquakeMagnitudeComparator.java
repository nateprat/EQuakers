...
public class EarthquakeMagnitudeComparator implements Comparator<EarthquakeRecord> {

    @Override
    public int compare(EarthquakeRecord o1, EarthquakeRecord o2) {
        return Double.compare(o1.getEarthquake().getMagnitude(), o2.getEarthquake().getMagnitude());
    }
